...
1. **Open Obsidian**
2. **Right-click any file** in your vault (in the file explorer sidebar)
3. **Select "Show in system explorer"** (or "Reveal in Finder" on macOS)
4. **Copy the folder path** - this is your Obsidian vault directory

![Obsidian Reveal in Finder](https://via.placeholder.com/400x200/2D3748/FFFFFF?text=Right+click+%3E+Reveal+in+Finder)
...
2. **Navigate to Storage Settings**
   ...
   - You'll see your current notes directory

3. **Change Storage Location**
   - Click "Change Location" 
   - Navigate to your Obsidian vault folder (from Step 1)
...
3. **Benefits**:
   ...
   - Can set up specific Obsidian templates for this folder
...
### Obsidian Features You Can Use
- **[[Double bracket links]]** between floating notes and other notes
- **#Tags** for categorizing your quick notes  
- **Templates** for consistent floating note structure
- **Daily notes** integration
- **Graph view** to see connections between floating and regular notes

### Recommended Obsidian Plugins
- **Templater**: Auto-populate floating notes with templates
- **Quick Switcher++**: Quickly find and open floating notes
- **Note Refactor**: Extract content from floating notes to permanent notes
...
### Sync Delays
- **Auto-refresh**: Most changes appear within seconds
- **Manual refresh**: Force refresh Obsidian if needed
- **File watchers**: Obsidian automatically detects file changes

### Character Encoding
- **UTF-8**: Both apps use UTF-8 encoding by default
- **Special characters**: Emojis and special characters work in both apps
...
✅ Use Obsidian's powerful features on your floating notes  
✅ Maintain your existing Obsidian workflow  
